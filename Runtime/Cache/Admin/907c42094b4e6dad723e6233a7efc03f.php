        ...
        <div class="form-group">
            ...
            <div >
                <select name="group" id="group">
                    <?php if(is_array($groups)): $i = 0; $__LIST__ = $groups;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo == $info['group']): ?><option value="<?php echo ($key); ?>" selected><?php echo ($vo); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
        </div>
        <div class="form-group">
