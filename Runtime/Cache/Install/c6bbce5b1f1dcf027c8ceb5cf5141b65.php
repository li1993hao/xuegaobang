...
<html>
    <head>
        ...
        <!-- Le styles -->
        <link href="/jdicms/Public/static/bootstrap/css/bootstrap.css" rel="stylesheet">
        <link href="/jdicms/Public/static/bootstrap/css/bootstrap-responsive.css" rel="stylesheet">
        <link href="/jdicms/Public/Install/css/install.css" rel="stylesheet">

        <!-- Le HTML5 shim, for IE6-8 support of HTML5 elements -->
        <!--[if lt IE 9]>
            <script src="assets/js/html5shiv.js"></script>
        <![endif]-->
        <script src="/jdicms/Public/static/jquery-1.10.2.min.js"></script>
        <script src="/jdicms/Public/static/bootstrap/js/bootstrap.js"></script>
    </head>
    ...
    <li><a href="javascript:;"><?php if(($_SESSION['jdi_']['update']) == "1"): ?>升级<?php else: ?>安装<?php endif; ?></a></li>
